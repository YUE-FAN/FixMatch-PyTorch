...
class WideResnet_leaky(nn.Module):
    def __init__(self, k=2, n=28, drop_rate=0, n_classes=10):
    ...
    def forward(self, x):
        ...
        return [ret1, ret2, ret3, ret4, ret5, feat]
...
def wideresnetleaky(depth, widen_factor, drop_rate, num_classes):
    """
    Constructs a WideResNet model.
    """
    return WideResnet_leaky(k=widen_factor, n=depth, drop_rate=drop_rate, n_classes=num_classes)
...
if __name__ == "__main__":
    ...
    # net = WideResnet(k=2, n=28, n_classes=10)
